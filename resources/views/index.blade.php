...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="assets/backend/images/hilt.jpeg" />
</head>
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="backend/assets/images/logo.svg"
                        alt="logo" /></a>
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle " src="backend/assets/images/faces/face15.jpg"
                                    alt="">
